...
@Injectable()
export class EditorialEventSequelizeRepository implements IEditorialEventsRepository {
  constructor(
    @InjectModel(EditorialEventModel) private readonly editorialEventModel: typeof EditorialEventModel,
  ) {}
