...
import { CREATE_EDITORIAL_EVENT, EDITORIAL_EVENT_INTERFACE } from 'src/constants';
...
export class EditorialEventsService {
  constructor(
    @Inject(EDITORIAL_EVENT_INTERFACE) private readonly editorialEventsRepository: IEditorialEventsRepository
  ){}
